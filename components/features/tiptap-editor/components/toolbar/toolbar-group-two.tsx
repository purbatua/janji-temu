...
interface ToolbarGroupTwoProps extends VariantProps<typeof toggleVariants> {
  editor: Editor;
  activeActions?: TextStyleAction[];
  mainActionCount?: number;
}

export const ToolbarGroupTwo: React.FC<ToolbarGroupTwoProps> = ({
  editor,
...
ToolbarGroupTwo.displayName = "ToolbarGroupTwo";

export default ToolbarGroupTwo;
